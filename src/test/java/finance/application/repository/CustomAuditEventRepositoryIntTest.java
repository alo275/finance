package finance.application.repository;

import finance.application.FinanceApp;
import finance.application.config.Constants;
import finance.application.config.audit.AuditEventConverter;
import finance.application.domain.PersistentAuditEvent;
...
import static finance.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
